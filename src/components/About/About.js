            ...
            <ul className='members'>
                <div className="card">
                    ...
                    <p className="card-content">
                        ...
                        American dream. Besides English, I speak both
                        Romanian, Russian, and Spanish. I hold a foreign
                        bachelor's degree in Computer Science, a Database
                        Management certificate from a local community
                        college, an A+ certificate, and a Front End
                        Development certificate from CTD. In terms of my
                        personal life, I am a happy wife and a mother of two
                ...
                <div className="card">
                    ...
                    <img src={Ekaterina} alt="Avatar" className="profile-image" />
                    <p className="card-content">
                ...
                <div className="card">
                    ...
                    <img src={Simon} alt="Avatar" className="profile-image" />
                    <p className="card-content">
                        Lorem ipsum dolor sit amet, consectetur adipiscing
                        elit, sed do eiusmod tempor incididunt ut labore et
                        dolore magna aliqua. Ut enim ad minim veniam, quis
                ...
                <div className="card">
                    ...
                    <img src={Cecilia} alt="Avatar" className="profile-image" />
                    <p className="card-content">
                        Lorem ipsum dolor sit amet, consectetur adipiscing
                        elit, sed do eiusmod tempor incididunt ut labore et
                        dolore magna aliqua. Ut enim ad minim veniam, quis
                ...
                <div className="card">
                    ...
                    <img src={Lara} alt="Avatar" className="profile-image" />
                    <p className="card-content">
                ...
                <div className="card">
                    ...
                    <img src={Manizha} alt="Avatar" className="profile-image" />
                    <p className="card-content">
                ...
                <div className="card">
                    ...
                    <p className="card-content">
                        ...
                        with Code the Dream. As a self-taught developer and
                ...
                <div className="card">
                    ...
                    <img src={Jacob} alt="Avatar" className="profile-image" />
                    <p className="card-content">
                        Jacob is a software engineer who served as a mentor
                        for this project. He has had a great time seeing
                        Shelf Share come together as a full stack app
                        through the extensive efforts of the team members.
                        Outside of work Jacob enjoys reading, cooking,
                ...
                <div className="card">
                    ...
                    <img src={Rachel} alt="Avatar" className="profile-image" />
                    <p className="card-content">
                        Rachel started her career as a school librarian
                        working with underserved youth and loved it- but a
                        change in life had her relocate to Germany. She
                        learned to make all of her favorite foods from
                        scratch including chocolate chip cookies, barbecue
                        sauce, and many fast food knockoffs! After returning
                        to the States, she focused on Information
                        Architecture and User Experience before joining Code
                        the Dream. She is SAFe Scrum certified and is
                        working on her PMP Project Management certification.
