        ...
        <div className="book-item">
            <p className="kidsAdults">
                {adult ? (
                    ...
                    <img src={ZeroPlus} alt="Kids" title="Kid friendly" />
                )}
            </p>
            <span className={status ? 'available' : 'unavailable'}>
                <Link
                    to={`/books/${item._id}`}
                    className={
                        status ? 'linkToAvailableBook' : 'linkToUnavailableBook'
                    }
                    data-id={status ? 'Press to open' : 'Borrowed'}
                >
                    {noImg ? (
                        <img
                            src={NoPic}
            ...
            <div className="book-item-body">
                <div>
                    ...
                    >
                        <img src={Message} alt="message_me" />
                    </a>
                </div>
